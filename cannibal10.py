...
def help3():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage3 = "      「◀️MUSIK CANNIBAL ™️▶️」\n" + \
                  ...
                  "      「◀️GAMBAR CANNIBAL ™️▶️」\n" + \
                  "「▶️」 " + key + "Listimage\n" + \
                  "「▶️」 " + key + "Addimg「Teks」\n" + \
                  "「▶️」 " + key + "Dellimg「Teks」\n" + \
                  "      「◀️STICKER CANNIBAL ™️▶️」\n" + \
                  "「▶️」 " + key + "Liststicker\n" + \
            ...
            if wait["ghost"] == True:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        ramdom.choice(ABC).updateGroup(G)
                        Ticket = random.choice(ABC).reissueGroupTicket(op.param1)
                        sw.acceptGroupInvitationByTicket(op.param1,Ticket)
                        sw.KickoutFromGroup(op.param1,[op.param2])
                        sw.InviteIntoGroup(op.param1,[Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid]
                                            ...
                                            try:
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        G.preventedJoinByTicket = False
                                                        kj.InviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Jmid])
                                                        cl.acceptGroupInvitationByTicket(op.param1)
                                                        cl.kickoutFromGroup(op.param1,[op.param2])
                                                        ki.acceptGroupInvitationByTicket(op.param1)
                                                        ki.kickoutFromGroup(op.param1,[op.param2])
                                                        kk.acceptGroupInvitationByTicket(op.param1)
                                                        kk.kickoutFromGroup(op.param1,[op.param2])
                                                        kc.acceptGroupInvitationByTicket(op.param1)
                                                        kc.kickoutFromGroup(op.param1,[op.param2])
                                                        kb.acceptGroupInvitationByTicket(op.param1)
                                                        kb.kickoutFromGroup(op.param1,[op.param2])
                                                        kd.acceptGroupInvitationByTicket(op.param1)
                                                        kd.kickoutFromGroup(op.param1,[op.param2])
                                                        ke.acceptGroupInvitationByTicket(op.param1)
                                                        ke.kickoutFromGroup(op.param1,[op.param2])
                                                        kf.acceptGroupInvitationByTicket(op.param1)
                                                        kf.kickoutFromGroup(op.param1,[op.param2])
                                                        kj.leaveGroup(op.param1)
                                                        X = kf.getGroup(op.param1)
                                                        X.preventedJoinByTicket = True
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/D")
                        ...
                        elif cmd == "cannibal" or cmd == "ririn":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "[CANNIBAL ™️ ].")
                               elapsed_time = time.time() - start
                               ki.sendMessage(msg.to, "╚CANNIBAL 1 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                               kk.sendMessage(msg.to, "╚CANNIBAL 2 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                               kc.sendMessage(msg.to, "╚CANNIBAL 3 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                               kb.sendMessage(msg.to, "╚CANNIBAL 4 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                               kd.sendMessage(msg.to, "╚CANNIBAL 5 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                               ke.sendMessage(msg.to, "╚CANNIBAL 6 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                               kf.sendMessage(msg.to, "╚CANNIBAL 7 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
                               kj.sendMessage(msg.to, "╚CANNIBAL 8 SIAP\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗".format(str(elapsed_time)))
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/D")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[️ PASUKAN CANNIBAL")
                                ki.sendMessage(msg.to, "[️ PASUKAN CANNIBAL")
                                kk.sendMessage(msg.to, "[️PAAUKAN CANNIBAL")
                                kc.sendMessage(msg.to, "[️PASUKAN CANNIBAL")
                                kb.sendMessage(msg.to, "[️PASUKAN CANNIBAL")
                                kd.sendMessage(msg.to, "[️PASUKAN CANNIBAL")
                                ke.sendMessage(msg.to, "[️PASUKAN CANNIBAL")
                                kf.sendMessage(msg.to, "[️PASUKAN CANNIBAL")
                                kj.sendMessage(msg.to, "[️PASUKAN CANNIBAL")
                                sw.sendMessage(msg.to, "[️ PASUKAN CANNIBAL")
                                cl.sendMessage(msg.to, "╔═══╗\n║╔═╗║\n║║─║╠╗╔╦══╦═╗\n║╚═╝║╚╝║╔╗║╔╗╗\n║╔═╗║║║║╔╗║║║║\n╚╝─╚╩╩╩╩╝╚╩╝╚╝")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                cl.sendMessage(msg.to,"✒ Can Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"✒ Can Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
